%ZOSV ;SFISC/AC - OS commands for M21 ;06/25/99  14:02
...
GETENV ;Get enviroment  (UCI^VOL^NODE)
 S Y=$P($ZU(0),",",1)_"^"_$P($ZU(0),",",2)_"^SAM-TEST^"_$P($ZU(0),",",2)
 Q
...
OSTYPE() ;Return 1 = PC/PLUS, 2 = NT, 3 = UNIX
 ...
 ;
PRI() Q 1   ; no-op on M21
SID() Q ""  ; TODO: Add something here
