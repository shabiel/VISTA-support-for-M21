%ZTLOAD1 ;SEA/RDS-TaskMan: P I: Queue ;09/23/08  10:06
 ...
 ; 
 ; VEN/SMH - LOCAL comment out transactions.
 ;
GET ;get task data
...
RECORD ;build record
 S ZTINC=$G(^%ZOSF("$INC"),0) ;Set to 1 if this system has $INCREMENT, otherwise 0.
 S ZTGOT=0
